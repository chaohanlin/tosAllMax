...
const AM_pool_2025 = [597, 599, 601, 603, 605, 816, 817, 818, 819, 820, 821, 822, 823, 824, 825, 826, 827, 1041, 1042, 1043, 1044, 1045, 1126, 1127, 1128, 1129, 1130, 1181, 1182, 1183, 1184, 1185, 1191, 1192, 1193, 1194, 1195, 1261, 1262, 1263, 1264, 1265, 1266, 1267, 1268, 1269, 1270, 1311, 1312, 1313, 1314, 1315, 1327, 1329, 1331, 1333, 1335, 1336, 1337, 1338, 1339, 1340, 1366, 1367, 1368, 1369, 1370, 1390, 1391, 1392, 1393, 1394, 1406, 1407, 1408, 1409, 1410, 1666, 1667, 1668, 1669, 1670, 1720, 1721, 1722, 1723, 1724, 1811, 1812, 1813, 1814, 1815, 1868, 1869, 1870, 1916, 1917, 1918, 1928, 1926, 1930, 1922, 1924, 1932, 1934, 1936, 2001, 2002, 2003, 2004, 2005, 2007, 2011, 2015, 2009, 2013, 2017, 2019, 2021, 2041, 2043, 2045, 2047, 2049, 2054, 2058, 2060, 2052, 2056, 2062, 2064, 2066, 2086, 2082, 2083, 2084, 2085, 2087, 2088, 2089, 2131, 2130, 2132, 2129, 2133, 2134, 2135, 2136, 2181, 2182, 2183, 2184, 2185, 2223, 2219, 2221, 2217, 2225, 2227, 2229, 2231, 2259, 2269, 2266, 2261, 2271, 2262, 2274, 2277, 2275, 2273, 2272, 2263, 2264, 2268, 2276, 2265, 2306, 2307, 2310, 2308, 2309, 2311, 2312, 2313, 2383, 2381, 2385, 2382, 2384, 2386, 2387, 2388, 2431, 2432, 2433, 2434, 2435, 2486, 2487, 2488, 2481, 2482, 2483, 2484, 2485, 2498, 2497, 2499, 2496, 2500, 2501, 2502, 2503, 2546, 2547, 2548, 2549, 2550, 2551, 2552, 2553, 2554, 2555, 2570, 2567, 2568, 2566, 2569, 2571, 2572, 2573, 2602, 2604, 2606, 2608, 2610, 2637, 2639, 2640, 2636, 2638, 2641, 2642, 2643, 2688, 2689, 2690, 2686, 2687, 2691, 2692, 2693, 2731, 2732, 2733, 2734, 2735, 2746, 2743, 2742, 2740, 2744, 2741, 2747, 2745, 2756, 2757, 2758, 2759, 2760, 2767, 2763, 2764, 2766, 2765, 2762, 2768, 2769, 2796, 2798, 2800, 2808, 2803, 2806, 2804, 2809, 2807, 2810, 2805, 2820, 2821, 2822, 2823, 2824, 2827, 2828, 2831, 2829, 2830, 2832, 2833, 2834, 2842, 2839, 2841, 2838, 2840, 2843, 2844, 2845, 2868, 2869, 2870, 2866, 2867, 2871, 2872, 2873, 2881, 2882, 2883, 2884, 2885, 2916, 2915, 2919, 2917, 2918, 2920, 2921, 2922, 10047, 10048, 10049, 10050, 10100, 10101, 10102, 10103, 10118, 10119, 10137, 10138, 10146, 10147, 10165, 10166, 10170, 10171, 10197, 10198, 10235, 10236, 10270, 10271, 10278, 10279, 10284, 10285, 10309, 10310, 10372, 10373, 10408, 10409, 10416, 10417, 10455, 10456, 10480, 10481, 10519, 10520, 10489, 10490, 10622, 10620, 10621, 10623, 10624, 10625, 10659, 10660, 10657, 10658, 10661, 10662, 10663, 10714, 10715, 10711, 10712, 10713, 10716, 10774, 10773, 10771, 10772, 10775, 10776];
// 方便保留往年資料或使用其他測試資料
const AM_pool = AM_pool_2025;
    ...
    <div className="card-info" ref={cardInfoRef} style={style}>
      ...
      {(cardData[card]?.value ?? []).map(([value, quantity], i) => (
        <span className="float-score__card" key={value}>
          <img
            src={`https://d1h5mn9kk900cf.cloudfront.net/toswebsites/gallery/icons/${String(value).padStart(4, '0')}.jpg`}
            alt={value}
  ...
  return (
    <div className="app-container">
      <div className="popup-container">
        ...
        評價者：微醺盜賊    協助完成:Hiteku、璇   圖片製作:gyw9s6tpcp
              ...
              <React.Fragment key={key}>
                <tr>
                  <td style={{ width: '77px' }} rowSpan="2">
                    <img
                      src={`https://d1h5mn9kk900cf.cloudfront.net/toswebsites/gallery/icons/${String(key).padStart(4, '0')}.jpg`}
                      alt={key}
              ...
              <td className="card-list--left-align">
                ...
                {highestMaterialCandidate.map((id, index) => (
                  <React.Fragment key={index}>
                    <img
                      src={`https://d1h5mn9kk900cf.cloudfront.net/toswebsites/gallery/icons/${String(id).padStart(4, '0')}.jpg`}
                      alt={`icon_${id}`}
                      style={{ width: iconWidth + 'px', borderRadius: '9%' }}
                    />
